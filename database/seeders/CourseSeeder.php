...
class CourseSeeder extends Seeder
{
    ...
    public function run()
    {
        $c1 = Course::create([
            ...
            'video'     => '<iframe width="560" height="315" src="https://www.youtube.com/embed/flp0R1VN-6U" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>',
        ]);
        $c1->styles()->attach(1);
