            ...
            <div class="bg-white py-6 px-4 sm:p-6">
                ...
                <div class="mt-6 grid grid-cols-4 gap-6">
                    ...
                    <div class="col-span-4">
                        <label for="terms" class="block text-sm font-medium text-gray-700">Terms of use</label>
                        <textarea wire:model="terms" rows="10"
                    ...
                    <div class="col-span-4">
                        <label for="privacy" class="block text-sm font-medium text-gray-700">Privacy policy</label>
                        <textarea wire:model="privacy" rows="10"
                            class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 pxx-3 focus:outline-none focus:ring-gray-900 focus:border-gray-900 sm:text-sm"></textarea>
                    </div>
